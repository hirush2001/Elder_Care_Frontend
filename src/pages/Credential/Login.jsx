...
export default function Login() {
  ...
  const roles = [
    { id: "Elder", title: "Elder", Icon: UserIcon, desc: "Access for elders / guardians" },
    { id: "Caregiver", title: "Caregiver", Icon: UserGroupIcon, desc: "Access for caregivers" },
    { id: "Admin", title: "Admin", Icon: ShieldCheckIcon, desc: "Administrator access" },
  ];
              ...
              {roles.map((r) => {
                ...
                return (
                  <button
                    ...
                    className={`flex-1 flex flex-col items-center justify-center gap-2 py-3 rounded-xl border shadow-sm transition focus:outline-none focus:ring-2 focus:ring-offset-1 cursor-pointer
                      ${isActive ? "bg-[#eef6ff] border-[#0b6ff0] ring-1 ring-[#0b6ff0]/30" : "bg-white border-gray-200"}
                    `}
                    aria-pressed={isActive}
                    title={r.desc}
                  >
                    <ActiveIcon className={`w-6 h-6 ${isActive ? "text-[#0b6ff0]" : "text-gray-400"}`} />
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white shadow-sm cursor-pointer"
